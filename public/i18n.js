...
(function () {
    ...
    const T = {
        pt: {
            ...
            'landing.wc.album.desc': 'Marque os 985 cromos do álbum oficial, veja faltantes e repetidas. Compartilhe seu link — o app cruza automaticamente com seus amigos: <strong>quais ele te dá</strong> e <strong>quais você dá pra ele</strong>.',
        ...
        en: {
            ...
            'landing.wc.album.desc': 'Mark all 985 stickers from the official album, see missing and duplicates. Share your link — the app cross-matches with your friends: <strong>what they give you</strong> and <strong>what you give them</strong>.',
        ...
        es: {
            ...
            'landing.wc.album.desc': 'Marcá las 985 figuritas del álbum oficial, mirá faltantes y repetidas. Compartí tu link — la app cruza automáticamente con tus amigos: <strong>cuáles te da</strong> y <strong>cuáles le das</strong>.',
