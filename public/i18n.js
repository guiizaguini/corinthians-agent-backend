...
(function () {
    ...
    const T = {
        pt: {
            ...
            'app.bell.title': 'Notificações',
            'app.bell.empty': 'Sem novidades por aqui.',
            'app.bell.close': 'Fechar',
            'app.bell.notifications': 'Notificações',
            'app.bell.ach.eyebrow': 'Conquista desbloqueada',
            'app.bell.friend_req.eyebrow': 'Pedido de amizade',
            'app.bell.friend_req.fallback_name': 'Alguém',
            'app.bell.friend_req.desc': 'Quer te adicionar como amigo',
            'app.bell.companion.eyebrow': 'Companheiros de jogo',
            'app.bell.companion.title_one': '{n} confirmação pendente',
            'app.bell.companion.title_plural': '{n} confirmações pendentes',
            'app.bell.companion.desc': 'Alguém te marcou como companhia em um jogo',
            ...
            'app.album.share_download': 'Baixar PDF',
            'app.album.share_pdf_title': 'Folha de Controle (PDF)',
            'app.album.share_pdf_desc': 'Imprima ou compartilhe um PDF com a tabela de todas as figurinhas — as que você já tem já vêm marcadas.',
            ...
            // ====== APP — REDE SOCIAL (sidebar + composer + feed) ======
            'app.rede.toggle.title': 'Sua rede',
            'app.rede.toggle.friends': '{n} amigos',
            'app.rede.toggle.friends_one': '{n} amigo',
            'app.rede.toggle.pending': '{n} pendente',
            'app.rede.toggle.pending_plural': '{n} pendentes',
            'app.rede.search_ph': 'Buscar @username ou nome...',
            'app.rede.refresh': 'Atualizar',
            'app.rede.section.results': 'Resultados',
            'app.rede.section.incoming': 'Recebidas',
            'app.rede.section.companion_requests': 'Pediram pra confirmar',
            'app.rede.section.outgoing': 'Enviadas',
            'app.rede.section.friends': 'Amigos',
            'app.rede.empty.no_friends': 'Você ainda não tem amigos. Use a busca acima pra encontrar pelo @username.',
            'app.rede.empty.search_none': 'Ninguém encontrado.',
            'app.rede.search.searching': 'Buscando...',
            'app.rede.loading': 'Carregando...',
            'app.rede.error': 'Erro',
            // Composer
            'app.rede.composer.new_post': 'NOVO POST',
            'app.rede.composer.placeholder': 'Conta a história do jogo. Um detalhe, um gol, um cheiro do estádio...',
            'app.rede.composer.title_ph': 'Título (opcional)',
            'app.rede.composer.no_attendance': '— Sem ingresso —',
            'app.rede.composer.private': 'Privada',
            'app.rede.composer.public': 'Pública',
            'app.rede.composer.more_options': 'Mais opções',
            'app.rede.composer.post_btn': 'Postar',
            'app.rede.composer.posting': 'Postando...',
            'app.rede.composer.me_fallback': 'Eu',
            // User card actions
            'app.rede.user.no_name': 'Sem nome',
            'app.rede.user.action.collection': 'Ver coleção',
            'app.rede.user.action.compare': 'Comparar',
            'app.rede.user.action.remove': 'Remover',
            'app.rede.user.action.accept': 'Aceitar',
            'app.rede.user.action.reject': 'Rejeitar',
            'app.rede.user.action.cancel': 'Cancelar',
            'app.rede.user.action.add': 'Adicionar',
            'app.rede.user.tag.waiting': 'Aguardando',
            'app.rede.user.tag.requested': 'Solicitado',
            'app.rede.user.tag.is_friend': 'Já é amigo',
            'app.rede.user.confirm_unfriend': 'Remover amizade?',
            // Last seen
            'app.rede.last_seen.long_time': 'há muito tempo',
            'app.rede.last_seen.min': 'há {n}min',
            'app.rede.last_seen.h': 'há {n}h',
            'app.rede.last_seen.d': 'há {n}d',
            'app.rede.last_seen.months': 'há meses',
            'app.rede.last_seen.online': 'Online agora',
            // Companion request
            'app.rede.companion.someone': 'Alguém',
            'app.rede.companion.confirm': 'Confirmar',
            'app.rede.companion.not_going': 'Não vou',
            'app.rede.companion.didnt_go': 'Não fui',
            'app.rede.companion.verb_future': 'marcou que vai com você em',
            'app.rede.companion.verb_past': 'marcou que foi com você em',
            'app.rede.companion.confirm_reject_future': 'Você não vai nesse jogo? Vamos remover você como companhia.',
            'app.rede.companion.confirm_reject_past': 'Você não foi nesse jogo? Vamos remover você como companhia.',
            // Feed
            'app.feed.loading': 'Carregando feed...',
            'app.feed.empty': 'Nenhuma atividade ainda. Quando seus amigos marcarem jogos, aparece aqui.',
            'app.feed.fallback.friend': 'Amigo',
            'app.feed.fallback.someone': 'amigo',
            'app.feed.tag.you': 'você',
            'app.feed.delete_confirm': 'Remover essa nota? Essa ação não pode ser desfeita.',
            'app.feed.delete_title': 'Remover essa nota',
            'app.feed.time.now': 'agora há pouco',
            'app.feed.time.h': '{n}h atrás',
            'app.feed.time.d': '{n}d atrás',
            // Feed actions
            'app.feed.action.unlocked': 'desbloqueou uma conquista',
            'app.feed.action.posted_note': 'publicou uma nota',
            'app.feed.action.going_copa': 'vai na Copa',
            'app.feed.action.attended': 'marcou presença',
            'app.feed.action.together_going_copa': 'vão juntos na Copa',
            'app.feed.action.together_went_copa': 'foram juntos na Copa',
            'app.feed.action.together_going_game': 'vão juntos no jogo',
            'app.feed.action.together_went_game': 'foram juntos no jogo',
            'app.feed.palpite.singular': 'palpitou um jogo da Copa',
            'app.feed.palpite.plural': 'palpitou {n} jogos da Copa',
            'app.feed.palpite.see': 'Ver palpites ({n})',
            'app.feed.sector': 'Setor {nome}',
            'app.feed.copa_label': 'FIFA WORLD CUP 2026',
            'app.feed.copa_bolao_label': 'FIFA WORLD CUP 2026 · BOLÃO',
            ...
            // Perfil — hero + KPIs + conquistas + danger zone + edit modal
            'app.perfil.no_club': 'Sem time',
            'app.perfil.no_handle': 'Sem @username',
            'app.perfil.fallback_name': 'Torcedor',
            'app.perfil.kpi_aprov_short': 'Aprov.',
            'app.perfil.kpi_conquistas': 'Conquistas',
            'app.perfil.conq_title': 'Conquistas',
            'app.perfil.conq_loading': 'Carregando conquistas...',
            'app.perfil.conq_loading_err': 'Erro ao carregar conquistas',
            'app.perfil.conq_empty': 'Nenhuma conquista nessa categoria.',
            'app.perfil.conq_stats': '<b>{n}</b> de {total}',
            'app.perfil.conq_filter_all': 'Todas',
            'app.perfil.conq_filter_presenca': 'Presença',
            'app.perfil.conq_filter_vitorias': 'Vitórias',
            'app.perfil.conq_filter_especial': 'Especiais',
            'app.perfil.conq_filter_colecao': 'Coleção',
            'app.perfil.conq_filter_social': 'Sociais',
            'app.perfil.conq_filter_bolao': 'Bolão',
            'app.perfil.danger_title': 'Zona perigosa',
            'app.perfil.danger_account_title': 'Excluir minha conta',
            'app.perfil.danger_account_desc_html': 'Apaga seu perfil, presenças, palpites, amizades e te tira de todos os bolões. <strong>Essa ação é irreversível.</strong>',
            'app.perfil.danger_btn': 'Excluir conta',
            // Editar perfil (modal)
            'app.perfil.edit_title': 'Editar perfil',
            'app.perfil.edit_subtitle': 'Atualize seu nome e o time que você torce.',
            'app.perfil.field_name': 'Nome',
            'app.perfil.field_username': 'Username (pra os amigos te encontrarem)',
            'app.perfil.field_username_help': '3 a 30 caracteres · só letras, números, _ ou .',
            'app.perfil.field_email': 'Email (não editável)',
            'app.perfil.field_club': 'Time que você torce',
            'app.perfil.field_club_skip': '— Prefiro não escolher —',
            'app.perfil.btn_save_loading': 'Salvando...',
        },
        ...
        en: {
            ...
            'app.bell.title': 'Notifications',
            'app.bell.empty': 'Nothing new here.',
            'app.bell.close': 'Close',
            'app.bell.notifications': 'Notifications',
            'app.bell.ach.eyebrow': 'Achievement unlocked',
            'app.bell.friend_req.eyebrow': 'Friend request',
            'app.bell.friend_req.fallback_name': 'Someone',
            'app.bell.friend_req.desc': 'Wants to add you as a friend',
            'app.bell.companion.eyebrow': 'Match companions',
            'app.bell.companion.title_one': '{n} pending confirmation',
            'app.bell.companion.title_plural': '{n} pending confirmations',
            'app.bell.companion.desc': 'Someone tagged you as their match companion',
            ...
            'app.album.share_download': 'Download PDF',
            'app.album.share_pdf_title': 'Control Sheet (PDF)',
            'app.album.share_pdf_desc': 'Print or share a PDF with the full sticker table — the ones you already own come pre-marked.',
            ...
            // ====== APP — SOCIAL (sidebar + composer + feed) ======
            'app.rede.toggle.title': 'Your network',
            'app.rede.toggle.friends': '{n} friends',
            'app.rede.toggle.friends_one': '{n} friend',
            'app.rede.toggle.pending': '{n} pending',
            'app.rede.toggle.pending_plural': '{n} pending',
            'app.rede.search_ph': 'Search @username or name...',
            'app.rede.refresh': 'Refresh',
            'app.rede.section.results': 'Results',
            'app.rede.section.incoming': 'Incoming',
            'app.rede.section.companion_requests': 'Confirm requests',
            'app.rede.section.outgoing': 'Outgoing',
            'app.rede.section.friends': 'Friends',
            'app.rede.empty.no_friends': 'No friends yet. Use the search above to find someone by @username.',
            'app.rede.empty.search_none': 'No one found.',
            'app.rede.search.searching': 'Searching...',
            'app.rede.loading': 'Loading...',
            'app.rede.error': 'Error',
            'app.rede.composer.new_post': 'NEW POST',
            'app.rede.composer.placeholder': 'Tell the story of the match. A detail, a goal, the smell of the stadium...',
            'app.rede.composer.title_ph': 'Title (optional)',
            'app.rede.composer.no_attendance': '— No ticket —',
            'app.rede.composer.private': 'Private',
            'app.rede.composer.public': 'Public',
            'app.rede.composer.more_options': 'More options',
            'app.rede.composer.post_btn': 'Post',
            'app.rede.composer.posting': 'Posting...',
            'app.rede.composer.me_fallback': 'Me',
            'app.rede.user.no_name': 'No name',
            'app.rede.user.action.collection': 'View collection',
            'app.rede.user.action.compare': 'Compare',
            'app.rede.user.action.remove': 'Remove',
            'app.rede.user.action.accept': 'Accept',
            'app.rede.user.action.reject': 'Reject',
            'app.rede.user.action.cancel': 'Cancel',
            'app.rede.user.action.add': 'Add',
            'app.rede.user.tag.waiting': 'Waiting',
            'app.rede.user.tag.requested': 'Requested',
            'app.rede.user.tag.is_friend': 'Already a friend',
            'app.rede.user.confirm_unfriend': 'Remove friend?',
            'app.rede.last_seen.long_time': 'a long time ago',
            'app.rede.last_seen.min': '{n}min ago',
            'app.rede.last_seen.h': '{n}h ago',
            'app.rede.last_seen.d': '{n}d ago',
            'app.rede.last_seen.months': 'months ago',
            'app.rede.last_seen.online': 'Online now',
            'app.rede.companion.someone': 'Someone',
            'app.rede.companion.confirm': 'Confirm',
            'app.rede.companion.not_going': 'Not going',
            'app.rede.companion.didnt_go': 'Didn’t go',
            'app.rede.companion.verb_future': 'said you’re going together to',
            'app.rede.companion.verb_past': 'said you went together to',
            'app.rede.companion.confirm_reject_future': 'You’re not going to this match? We’ll remove you as company.',
            'app.rede.companion.confirm_reject_past': 'You didn’t go to this match? We’ll remove you as company.',
            'app.feed.loading': 'Loading feed...',
            'app.feed.empty': 'No activity yet. When your friends mark matches, they’ll show up here.',
            'app.feed.fallback.friend': 'Friend',
            'app.feed.fallback.someone': 'friend',
            'app.feed.tag.you': 'you',
            'app.feed.delete_confirm': 'Remove this note? This action cannot be undone.',
            'app.feed.delete_title': 'Remove this note',
            'app.feed.time.now': 'just now',
            'app.feed.time.h': '{n}h ago',
            'app.feed.time.d': '{n}d ago',
            'app.feed.action.unlocked': 'unlocked an achievement',
            'app.feed.action.posted_note': 'posted a note',
            'app.feed.action.going_copa': 'is going to the World Cup',
            'app.feed.action.attended': 'attended the match',
            'app.feed.action.together_going_copa': 'are going together to the World Cup',
            'app.feed.action.together_went_copa': 'went together to the World Cup',
            'app.feed.action.together_going_game': 'are going together to the match',
            'app.feed.action.together_went_game': 'went together to the match',
            'app.feed.palpite.singular': 'predicted a World Cup match',
            'app.feed.palpite.plural': 'predicted {n} World Cup matches',
            'app.feed.palpite.see': 'See predictions ({n})',
            'app.feed.sector': 'Sector {nome}',
            'app.feed.copa_label': 'FIFA WORLD CUP 2026',
            'app.feed.copa_bolao_label': 'FIFA WORLD CUP 2026 · POOL',
            ...
            'app.perfil.no_club': 'No club',
            'app.perfil.no_handle': 'No @username',
            'app.perfil.fallback_name': 'Supporter',
            'app.perfil.kpi_aprov_short': 'Win %',
            'app.perfil.kpi_conquistas': 'Achievements',
            'app.perfil.conq_title': 'Achievements',
            'app.perfil.conq_loading': 'Loading achievements...',
            'app.perfil.conq_loading_err': 'Failed to load achievements',
            'app.perfil.conq_empty': 'No achievements in this category.',
            'app.perfil.conq_stats': '<b>{n}</b> of {total}',
            'app.perfil.conq_filter_all': 'All',
            'app.perfil.conq_filter_presenca': 'Attendance',
            'app.perfil.conq_filter_vitorias': 'Wins',
            'app.perfil.conq_filter_especial': 'Special',
            'app.perfil.conq_filter_colecao': 'Collection',
            'app.perfil.conq_filter_social': 'Social',
            'app.perfil.conq_filter_bolao': 'Pool',
            'app.perfil.danger_title': 'Danger zone',
            'app.perfil.danger_account_title': 'Delete my account',
            'app.perfil.danger_account_desc_html': 'Wipes your profile, attendances, predictions, friendships and removes you from every pool. <strong>This action is irreversible.</strong>',
            'app.perfil.danger_btn': 'Delete account',
            'app.perfil.edit_title': 'Edit profile',
            'app.perfil.edit_subtitle': 'Update your name and the club you support.',
            'app.perfil.field_name': 'Name',
            'app.perfil.field_username': 'Username (so friends can find you)',
            'app.perfil.field_username_help': '3 to 30 characters · letters, numbers, _ or . only',
            'app.perfil.field_email': 'Email (not editable)',
            'app.perfil.field_club': 'Club you support',
            'app.perfil.field_club_skip': '— I’d rather not say —',
            'app.perfil.btn_save_loading': 'Saving...',
        },
        ...
        es: {
            ...
            'bell.system.eyebrow': 'Aviso',
            'app.bell.title': 'Notificaciones',
            'app.bell.empty': 'No hay novedades por acá.',
            'app.bell.close': 'Cerrar',
            'app.bell.notifications': 'Notificaciones',
            'app.bell.ach.eyebrow': 'Logro desbloqueado',
            'app.bell.friend_req.eyebrow': 'Solicitud de amistad',
            'app.bell.friend_req.fallback_name': 'Alguien',
            'app.bell.friend_req.desc': 'Te quiere agregar como amigo',
            'app.bell.companion.eyebrow': 'Compañeros de partido',
            'app.bell.companion.title_one': '{n} confirmación pendiente',
            'app.bell.companion.title_plural': '{n} confirmaciones pendientes',
            'app.bell.companion.desc': 'Alguien te marcó como compañía en un partido',
            ...
            'app.album.share_copy_text': 'Copiar texto',
            'app.album.share_download': 'Descargar PDF',
            'app.album.share_pdf_title': 'Hoja de Control (PDF)',
            'app.album.share_pdf_desc': 'Imprimí o compartí un PDF con la tabla de todas las figuritas — las que ya tenés vienen marcadas.',
            ...
            // ====== APP — RED SOCIAL (sidebar + composer + feed) ======
            'app.rede.toggle.title': 'Tu red',
            'app.rede.toggle.friends': '{n} amigos',
            'app.rede.toggle.friends_one': '{n} amigo',
            'app.rede.toggle.pending': '{n} pendiente',
            'app.rede.toggle.pending_plural': '{n} pendientes',
            'app.rede.search_ph': 'Buscá @username o nombre...',
            'app.rede.refresh': 'Actualizar',
            'app.rede.section.results': 'Resultados',
            'app.rede.section.incoming': 'Recibidas',
            'app.rede.section.companion_requests': 'Te pidieron confirmar',
            'app.rede.section.outgoing': 'Enviadas',
            'app.rede.section.friends': 'Amigos',
            'app.rede.empty.no_friends': 'Todavía no tenés amigos. Usá la búsqueda de arriba para encontrar a alguien por @username.',
            'app.rede.empty.search_none': 'No se encontró a nadie.',
            'app.rede.search.searching': 'Buscando...',
            'app.rede.loading': 'Cargando...',
            'app.rede.error': 'Error',
            'app.rede.composer.new_post': 'NUEVO POST',
            'app.rede.composer.placeholder': 'Contá la historia del partido. Un detalle, un gol, un olor a cancha...',
            'app.rede.composer.title_ph': 'Título (opcional)',
            'app.rede.composer.no_attendance': '— Sin entrada —',
            'app.rede.composer.private': 'Privada',
            'app.rede.composer.public': 'Pública',
            'app.rede.composer.more_options': 'Más opciones',
            'app.rede.composer.post_btn': 'Publicar',
            'app.rede.composer.posting': 'Publicando...',
            'app.rede.composer.me_fallback': 'Yo',
            'app.rede.user.no_name': 'Sin nombre',
            'app.rede.user.action.collection': 'Ver colección',
            'app.rede.user.action.compare': 'Comparar',
            'app.rede.user.action.remove': 'Quitar',
            'app.rede.user.action.accept': 'Aceptar',
            'app.rede.user.action.reject': 'Rechazar',
            'app.rede.user.action.cancel': 'Cancelar',
            'app.rede.user.action.add': 'Agregar',
            'app.rede.user.tag.waiting': 'Esperando',
            'app.rede.user.tag.requested': 'Solicitado',
            'app.rede.user.tag.is_friend': 'Ya es amigo',
            'app.rede.user.confirm_unfriend': '¿Quitar la amistad?',
            'app.rede.last_seen.long_time': 'hace mucho',
            'app.rede.last_seen.min': 'hace {n}min',
            'app.rede.last_seen.h': 'hace {n}h',
            'app.rede.last_seen.d': 'hace {n}d',
            'app.rede.last_seen.months': 'hace meses',
            'app.rede.last_seen.online': 'En línea ahora',
            'app.rede.companion.someone': 'Alguien',
            'app.rede.companion.confirm': 'Confirmar',
            'app.rede.companion.not_going': 'No voy',
            'app.rede.companion.didnt_go': 'No fui',
            'app.rede.companion.verb_future': 'marcó que va con vos a',
            'app.rede.companion.verb_past': 'marcó que fue con vos a',
            'app.rede.companion.confirm_reject_future': '¿No vas a este partido? Te vamos a quitar como compañía.',
            'app.rede.companion.confirm_reject_past': '¿No fuiste a este partido? Te vamos a quitar como compañía.',
            'app.feed.loading': 'Cargando feed...',
            'app.feed.empty': 'Todavía no hay actividad. Cuando tus amigos marquen partidos, va a aparecer acá.',
            'app.feed.fallback.friend': 'Amigo',
            'app.feed.fallback.someone': 'amigo',
            'app.feed.tag.you': 'vos',
            'app.feed.delete_confirm': '¿Eliminar esta nota? Esta acción no se puede deshacer.',
            'app.feed.delete_title': 'Eliminar esta nota',
            'app.feed.time.now': 'recién',
            'app.feed.time.h': 'hace {n}h',
            'app.feed.time.d': 'hace {n}d',
            'app.feed.action.unlocked': 'desbloqueó un logro',
            'app.feed.action.posted_note': 'publicó una nota',
            'app.feed.action.going_copa': 'va al Mundial',
            'app.feed.action.attended': 'estuvo en el partido',
            'app.feed.action.together_going_copa': 'van juntos al Mundial',
            'app.feed.action.together_went_copa': 'fueron juntos al Mundial',
            'app.feed.action.together_going_game': 'van juntos al partido',
            'app.feed.action.together_went_game': 'fueron juntos al partido',
            'app.feed.palpite.singular': 'pronosticó un partido del Mundial',
            'app.feed.palpite.plural': 'pronosticó {n} partidos del Mundial',
            'app.feed.palpite.see': 'Ver pronósticos ({n})',
            'app.feed.sector': 'Sector {nome}',
            'app.feed.copa_label': 'FIFA WORLD CUP 2026',
            'app.feed.copa_bolao_label': 'FIFA WORLD CUP 2026 · QUINIELA',
            ...
            'app.perfil.no_club': 'Sin club',
            'app.perfil.no_handle': 'Sin @username',
            'app.perfil.fallback_name': 'Hincha',
            'app.perfil.kpi_aprov_short': 'Rend.',
            'app.perfil.kpi_conquistas': 'Logros',
            'app.perfil.conq_title': 'Logros',
            'app.perfil.conq_loading': 'Cargando logros...',
            'app.perfil.conq_loading_err': 'Error al cargar los logros',
            'app.perfil.conq_empty': 'No hay logros en esta categoría.',
            'app.perfil.conq_stats': '<b>{n}</b> de {total}',
            'app.perfil.conq_filter_all': 'Todos',
            'app.perfil.conq_filter_presenca': 'Asistencia',
            'app.perfil.conq_filter_vitorias': 'Victorias',
            'app.perfil.conq_filter_especial': 'Especiales',
            'app.perfil.conq_filter_colecao': 'Colección',
            'app.perfil.conq_filter_social': 'Sociales',
            'app.perfil.conq_filter_bolao': 'Quiniela',
            'app.perfil.danger_title': 'Zona peligrosa',
            'app.perfil.danger_account_title': 'Eliminar mi cuenta',
            'app.perfil.danger_account_desc_html': 'Borra tu perfil, asistencias, pronósticos, amistades y te saca de todas las quinielas. <strong>Esta acción es irreversible.</strong>',
            'app.perfil.danger_btn': 'Eliminar cuenta',
            'app.perfil.edit_title': 'Editar perfil',
            'app.perfil.edit_subtitle': 'Actualizá tu nombre y el club al que le hinchás.',
            'app.perfil.field_name': 'Nombre',
            'app.perfil.field_username': 'Username (para que tus amigos te encuentren)',
            'app.perfil.field_username_help': '3 a 30 caracteres · solo letras, números, _ o .',
            'app.perfil.field_email': 'Email (no editable)',
            'app.perfil.field_club': '¿A qué club hinchás?',
            'app.perfil.field_club_skip': '— Prefiero no elegir —',
            'app.perfil.btn_save_loading': 'Guardando...',
        },
    };
